...
class ChatAdmin(admin.ModelAdmin):
  ...
  TEMPLATES_CONTENT_1_IT = [
    ...
    "Quando abbrevii è così: <span style='color:red;'>{en_abbrev}</span> "
    "E quando non abbrevii è così: <span style='color:red;'>{en_full}</span> "
    "Il significato è: <span style='color:blue;'>{it}</span>",

    "Possiamo parlare in modo abbreviato: <span style='color:red;'>{en_abbrev}</span> "
    "Oppure, se preferisci, senza abbreviazione: <span style='color:red;'>{en_full}</span> "
    "Tradotto: <span style='color:blue;'>{it}</span>",
    ...
    "Si abbrevia così: <span style='color:red;'>{en_abbrev}</span> "
    "Oppure senza abbreviazione: <span style='color:red;'>{en_full}</span> "
    "La traduzione è: <span style='color:blue;'>{it}</span>",

    "Questa frase può essere detta in forma abbreviata: <span style='color:red;'>{en_abbrev}</span> "
    "Oppure, se vuoi, senza abbreviazione: <span style='color:red;'>{en_full}</span> "
    "Significa: <span style='color:blue;'>{it}</span>",

    "Puoi parlare in modo abbreviato: <span style='color:red;'>{en_abbrev}</span> "
    "Oppure parlare senza abbreviazione: <span style='color:red;'>{en_full}</span> "
    "Che significa: <span style='color:blue;'>{it}</span>",

    "Possiamo usare la versione abbreviata: <span style='color:red;'>{en_abbrev}</span> "
    "Oppure la versione non abbreviata: <span style='color:red;'>{en_full}</span> "
    "Vuol dire: <span style='color:blue;'>{it}</span>",

    "C'è un modo abbreviato per dire: <span style='color:red;'>{en_abbrev}</span> "
    "Oppure, se vuoi, senza abbreviazione: <span style='color:red;'>{en_full}</span> "
    "Il significato è: <span style='color:blue;'>{it}</span>",

    "Abbreviato: <span style='color:red;'>{en_abbrev}</span> "
    "Senza abbreviare: <span style='color:red;'>{en_full}</span> "
    "Il significato è: <span style='color:blue;'>{it}</span>",

    "Con abbreviazione: <span style='color:red;'>{en_abbrev}</span> "
    "Senza abbreviazione: <span style='color:red;'>{en_full}</span> "
    "Significa: <span style='color:blue;'>{it}</span>",

    "Frase con abbreviazione: <span style='color:red;'>{en_abbrev}</span> "
    "Frase senza abbreviazione: <span style='color:red;'>{en_full}</span> "
    "Significa: <span style='color:blue;'>{it}</span>",

    "Frase abbreviata: <span style='color:red;'>{en_abbrev}</span> "
    "Frase senza abbreviare: <span style='color:red;'>{en_full}</span> "
    "Vuol dire: <span style='color:blue;'>{it}</span>",

    "Vediamo ora la versione abbreviata: <span style='color:red;'>{en_abbrev}</span> "
    "E quella senza abbreviazione: <span style='color:red;'>{en_full}</span> "
    "Il significato è: <span style='color:blue;'>{it}</span>"
  ]  
  TEMPLATES_CONTENT_1_FR = [
    ...
    "Quand tu abréges, c'est : <span style='color:red;'>{en_abbrev}</span> "
    "Et quand tu n'abréges pas, c'est : <span style='color:red;'>{en_full}</span> "
    "La signification est : <span style='color:blue;'>{fr}</span>",

    "On peut parler de façon abrégée : <span style='color:red;'>{en_abbrev}</span> "
    "Ou, si tu préfères, sans abréviation : <span style='color:red;'>{en_full}</span> "
    "Traduit : <span style='color:blue;'>{fr}</span>",
    ...
    "On l'abrège ainsi : <span style='color:red;'>{en_abbrev}</span> "
    "Ou sans abréviation : <span style='color:red;'>{en_full}</span> "
    "La traduction est : <span style='color:blue;'>{fr}</span>",

    "Cette phrase peut être dite sous forme abrégée : <span style='color:red;'>{en_abbrev}</span> "
    "Ou, si tu veux, sans abréviation : <span style='color:red;'>{en_full}</span> "
    "Cela signifie : <span style='color:blue;'>{fr}</span>",

    "Tu peux parler de manière abrégée : <span style='color:red;'>{en_abbrev}</span> "
    "Ou parler sans abréviation : <span style='color:red;'>{en_full}</span> "
    "Ce qui signifie : <span style='color:blue;'>{fr}</span>",

    "On peut utiliser la version abrégée : <span style='color:red;'>{en_abbrev}</span> "
    "Ou la version non abrégée : <span style='color:red;'>{en_full}</span> "
    "Elle veut dire : <span style='color:blue;'>{fr}</span>",

    "Il existe une façon abrégée de dire : <span style='color:red;'>{en_abbrev}</span> "
    "Ou, si tu veux, sans abréviation : <span style='color:red;'>{en_full}</span> "
    "La signification est : <span style='color:blue;'>{fr}</span>",

    "Abrégé : <span style='color:red;'>{en_abbrev}</span> "
    "Sans abréger : <span style='color:red;'>{en_full}</span> "
    "La signification est : <span style='color:blue;'>{fr}</span>",

    "Avec abréviation : <span style='color:red;'>{en_abbrev}</span> "
    "Sans abréviation : <span style='color:red;'>{en_full}</span> "
    "Cela signifie : <span style='color:blue;'>{fr}</span>",

    "Phrase avec abréviation : <span style='color:red;'>{en_abbrev}</span> "
    "Phrase sans abréviation : <span style='color:red;'>{en_full}</span> "
    "Cela signifie : <span style='color:blue;'>{fr}</span>",

    "Phrase abrégée : <span style='color:red;'>{en_abbrev}</span> "
    "Phrase sans abréger : <span style='color:red;'>{en_full}</span> "
    "Elle veut dire : <span style='color:blue;'>{fr}</span>",

    "Voyons maintenant la version abrégée : <span style='color:red;'>{en_abbrev}</span> "
    "Et celle sans abréviation : <span style='color:red;'>{en_full}</span> "
    "La signification est : <span style='color:blue;'>{fr}</span>"
  ]
  TEMPLATES_CONTENT_1_ES = [
    ...
    "Cuando abrevias queda así: <span style='color:red;'>{en_abbrev}</span> "
    "Y cuando no abrevias queda así: <span style='color:red;'>{en_full}</span> "
    "El significado es: <span style='color:blue;'>{es}</span>",

    "Podemos hablar de forma abreviada: <span style='color:red;'>{en_abbrev}</span> "
    "O si quieres, sin abreviar: <span style='color:red;'>{en_full}</span> "
    "Traducido: <span style='color:blue;'>{es}</span>",
    ...
    "Se abrevia así: <span style='color:red;'>{en_abbrev}</span> "
    "O sin abreviación: <span style='color:red;'>{en_full}</span> "
    "La traducción es: <span style='color:blue;'>{es}</span>",

    "Esta frase puede decirse de forma abreviada: <span style='color:red;'>{en_abbrev}</span> "
    "O si quieres, sin abreviarla: <span style='color:red;'>{en_full}</span> "
    "Esto significa: <span style='color:blue;'>{es}</span>",

    "Puedes hablar de manera abreviada: <span style='color:red;'>{en_abbrev}</span> "
    "O hablar sin abreviar: <span style='color:red;'>{en_full}</span> "
    "Lo que significa: <span style='color:blue;'>{es}</span>",

    "Podemos usar la versión abreviada: <span style='color:red;'>{en_abbrev}</span> "
    "O la versión no abreviada: <span style='color:red;'>{en_full}</span> "
    "Quiere decir: <span style='color:blue;'>{es}</span>",

    "Hay una forma abreviada de decir: <span style='color:red;'>{en_abbrev}</span> "
    "O si quieres, sin abreviación: <span style='color:red;'>{en_full}</span> "
    "El significado es: <span style='color:blue;'>{es}</span>",

    "Abreviado: <span style='color:red;'>{en_abbrev}</span> "
    "Sin abreviar: <span style='color:red;'>{en_full}</span> "
    "El significado es: <span style='color:blue;'>{es}</span>",

    "Con abreviación: <span style='color:red;'>{en_abbrev}</span> "
    "Sin abreviación: <span style='color:red;'>{en_full}</span> "
    "Significa: <span style='color:blue;'>{es}</span>",

    "Frase con abreviación: <span style='color:red;'>{en_abbrev}</span> "
    "Frase sin abreviación: <span style='color:red;'>{en_full}</span> "
    "Significa: <span style='color:blue;'>{es}</span>",

    "Frase abreviada: <span style='color:red;'>{en_abbrev}</span> "
    "Frase sin abreviar: <span style='color:red;'>{en_full}</span> "
    "Quiere decir: <span style='color:blue;'>{es}</span>",

    "Veamos ahora la versión abreviada: <span style='color:red;'>{en_abbrev}</span> "
    "Y la versión sin abreviar: <span style='color:red;'>{en_full}</span> "
    "El significado es: <span style='color:blue;'>{es}</span>"
  ]
