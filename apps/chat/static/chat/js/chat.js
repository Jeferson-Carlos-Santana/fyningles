const USER_NAME = document.body.dataset.username || "";
  ...
  document.addEventListener("DOMContentLoaded", function () {   
    ...
    const CORRECOES_VOZ = {
        ...
        "i have these object": "i have this object",
        "you have these object": "you have this object",
        "he has these object": "he has this object",
        "she has these object": "she has this object",
        "it has these object": "it has this object",
        "we have these object": "we have this object",
        "they have these object": "they have this object",
        "i want do it": "i won't do it",
        "they wearing happy": "they weren't happy",
        "are you walk to work": "i walk to work",
        "are you work to walk": "i walk to work",
        "are you work to work": "i walk to work",
        "are you walk to walk": "i walk to work",
        "i walk to walk": "i walk to work",
        "i work to work": "i walk to work",
        "i work to walk": "i walk to work",
        "shindles the truth": "She knows the truth",
        "she claims here early": "she cleans here early",
        "shi claims here early": "she cleans here early",
        "chi claims here early": "she cleans here early",
        "xi claims here early": "she cleans here early",
        "she clins here early": "she cleans here early",
    ...
    window.addEventListener("offline", () => {
      ...
      const NORMALIZACOES_POR_TARGET = [
        ...
        { input: "they do not it late", target: "they do not eat late" },
        ...
        { input: "de-ask for help", target: "they ask for help" },
        ...
        { input: "i want to hear you", target: "i will not hear you" },
        { input: "will there be here", target: "will they be here" },
        { input: "lethink carefully", target: "listen carefully" },
        { input: "you stand up please", target: "stand up please" },
        { input: "they know what", target: "they know us" },
        { input: "they know was", target: "they know us" },
        { input: "it closes lonely", target: "it closes slowly" },
        { input: "it close slowly", target: "it closes slowly" },
        { input: "it closes lowly", target: "it closes slowly" },
        { input: "which closes slowly", target: "it closes slowly" },
        { input: "i find the answers", target: "i find answers" },
        { input: "you bring yuta", target: "you bring water" },
        { input: "you bring the water", target: "you bring water" },
        { input: "you bring your", target: "you bring water" },
        { input: "they did into run", target: "they did not run" },
        { input: "they did into rum", target: "they did not run" },
        { input: "they did into ram", target: "they did not run" },
        { input: "they did not to run", target: "they did not run" },
        { input: "they did it to run", target: "they did not run" },
        { input: "the last song begins now", target: "the lesson begins now" },
        { input: "bring it to here please", target: "bring it here please" },
