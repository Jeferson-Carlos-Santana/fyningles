  ...
  document.addEventListener("DOMContentLoaded", function () {   
    ...
    window.addEventListener("offline", () => {
      ...
      const NORMALIZACOES_POR_TARGET = [
        ...
        { input: "they do not it late", target: "they don't eat late" },
        { input: "they do not italate", target: "they don't eat late" },
        { input: "they do not each late", target: "they don't eat late" },
